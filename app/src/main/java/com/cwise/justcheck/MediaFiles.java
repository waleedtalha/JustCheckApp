...
public class MediaFiles implements Parcelable {
    ...
    public MediaFiles(String id, String title, String dispayName, String size, String duration, String path, String dateAdded) {
        this.id = id;
        this.title = title;
